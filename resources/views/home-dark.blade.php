				...
				<div class="st__project__single p-relative">
					<div class="st__project__thumb">
						...
						<div class="st__project__content">
							<h2><a href="#">Experts in technology fields</a></h2>
...
<!-- ST Footer Area -->
<div class="st-footer-area p-relative pt-120 pb-32" style="background-image: url(assets/images/footer/bg.jpg);background-position: center center;background-size: cover;background-repeat: no-repeat;">
	<div class="container">
		<div class="row ft_borer">
			<div class="col-lg-3 wow fadeInUpBig">
